...
etc.screen = screen
print("ETC SCREEN: " + str(etc.screen) + " " +  str(screen))
...
for i in range(0, len(etc.mode_names)-1) :
    print("ETC MODE ROOT: " + etc.mode_root)
    
    try :
        etc.set_mode_by_index(i)
        print("ETC MODE: " + etc.mode)
